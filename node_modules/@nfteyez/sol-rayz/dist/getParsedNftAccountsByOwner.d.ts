...
export declare const getParsedNftAccountsByOwner: ({ publicAddress, connection, sanitize, strictNftStandard, stringifyPubKeys, sort, }: Options) => Promise<any>;
export declare const sanitizeMetaStrings: (metaString: any) => any;
