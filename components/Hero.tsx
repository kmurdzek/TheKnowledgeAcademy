...
const GhoulieCountdown = props => {
  ...
  return (
    <div className="mt-4 text-base sm:text-xl lg:text-lg xl:text-xl letter-spacing3 text-center">
      <p style={{ color: "#FFD051" }}>Release Coming Soon</p>
      <Countdown
...
const Hero = (props: HomeProps) => {
  ...
  */
  ...
  return (
    <div>
      <WalletCard></WalletCard>
      <a target="_blank" className="hover:opacity-60"></a>
      ...
      <div className="hero">
        <div className="inside px-8 md:px-0 pb-8">
          <img
            ...
            src="/logo_white.png"
          />
          <div className="welcome w-full h-fit flex flex-col md:flex-row text-white overflow-visible">
            <div className="logo-bg-cont h-auto" style={{ width: "26rem" }}>
              {startDateInThePast ? (
                wallet ? (
            ...
            <div className="ml-0 md:ml-4 py-0 md:pt-8 -mt-14 md:mt-0 text-center md:text-left px-8 md:px-0 pt-20">
              ...
              <p className="reg-font max-w-lg pt-3">
                <b>Full Release</b>:{" "}
                <span style={{ color: "rgb(255, 208, 81)" }}></span>
                June. 19th for 999 Academist, 0.05 ETH each (limit 1 per wallet)
              </p>
